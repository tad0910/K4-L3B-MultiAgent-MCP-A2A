...
## 3. Entity resolution và A2A protocol
 ...
 phải đánh giá `claimed_order_id` cùng candidate list, sau đó trả:

 - `resolved_order_ids`: candidate có evidence hỗ trợ;
 ...
 không retry vòng lặp giữa agents. Mỗi MCP call phải tạo evidence response hợp lệ trước khi
